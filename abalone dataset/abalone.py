...
dataOverSampled = overSample(concatData, 50)
...
newData = np.vstack((x0,x1,x2,x3,x4,x5,x6,x7))
newLabels = np.array(x8)
...
for item in testItems:
    ...
    print("True Class: " + str(newLabels[item]))            
